...
@section('title', 'GolfNewsTV - Highlight giải đấu')
@section('content')
    <div class="heading-page header-text">
        ...
        <div class="container mt-4">
            <div class="row">
                @foreach ($videoLists->items as $key => $item)
                    ...
                    @else
                        <div class="col-4">
                            <a href="{{ route('vod.highlight.watch', $item->snippet->resourceId->videoId) }}">
                                <div class="card mb-4">
        ...
        <div class="container mt-4" style="text-align: center; padding-bottom: 10px;">
            @if (isset($videoLists->prevPageToken))
                <a href="{{ route('vod.highlight.token_prev', $videoLists->prevPageToken) }}"><i class="fa fa-chevron-left pagination"
            ...
            @if (isset($videoLists->nextPageToken))
                <a href="{{ route('vod.highlight.token_next', $videoLists->nextPageToken) }}"><i class="fa fa-chevron-right pagination"
