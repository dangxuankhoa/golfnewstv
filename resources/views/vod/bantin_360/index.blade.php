...
@section('title', 'GolfNewsTV - Bản tin GolfNews 360')
@section('content')
    <div class="heading-page header-text">
        ...
        <div class="container mt-4" style="text-align: center; padding-bottom: 10px;">
            @if (isset($videoLists->prevPageToken))
                <a href="{{ route('vod.bantin_360.token_prev', $videoLists->prevPageToken) }}"><i class="fa fa-chevron-left pagination"
            ...
            @if (isset($videoLists->nextPageToken))
                <a href="{{ route('vod.bantin_360.token_next', $videoLists->nextPageToken) }}"><i class="fa fa-chevron-right pagination"
